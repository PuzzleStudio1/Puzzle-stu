<!--begin::Aside-->
<div class="accordion  accordion-toggle-arrow d-block d-md-none d-print-none" id="accordionExample4">
    <div class="card rounded-xl">
        <div class="card-header" id="headingTwo4">
            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo4">
                <i class="flaticon2-copy"></i> پنل کاربری
            </div>
        </div>
            ...
            <div class="card-body">
                <ul class="nav flex-column nav-pills" role="tablist">
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('admin.livecheck') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-04-19-122603/theme/html/demo1/dist/../src/media/svg/icons/Communication/Shield-thunder.svg--><svg
                            ...
                            <span class="nav-text font-weight-bold">نظارت بر کلاس‌ها</span>
                        </a>
                    </li>
                    @endcan
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('admin.dashboard') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Layout\Layout-right-panel-1.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">داشبورد</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('course.index') }}">
                            ...
                            <span class="nav-text font-weight-bold">لیست دوره ها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('users.index') }}">
                            ...
                            <span class="nav-text font-weight-bold">لیست کاربران</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('tasks.index') }}">
                            ...
                            <span class="nav-text font-weight-bold">گزارش کارها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('roles.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\General\Settings-1.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">نقش ها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('permissions.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Communication\Shield-user.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">دسترسی ها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('files') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Files\Selected-file.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                            ...
                            <span class="nav-text font-weight-bold">لیست فایل ها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link" href="{{ route('player.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Media\Airplay-video.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text">پخش کننده</span>
                        </a>
                    </li>
                    @can('read questions')
                    <li class="nav-item mr-3">
                        <a class="nav-link" href="{{ route('tvshow.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                            ...
                            <span class="nav-text">TVShow</span>
                        </a>
                    </li>
                    @endcan
                    <li class="nav-item mr-3">
                        <a class="nav-link" href="{{ route('tags.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\General\Attachment1.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link" href="{{ route('categories.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Files\Folder.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('booklet.index') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\General\Clipboard.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">جزوات</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{route('admin.payment.index')}}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Shopping\Sale2.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">فاکتور</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{route('notif.index')}}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-12-28-020759/theme/html/demo2/dist/../src/media/svg/icons/General/Notifications1.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <path
                            ...
                            <span class="nav-text font-weight-bold">اطلاعیه‌ها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{route('admin.twofactor')}}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-12-10-081610/theme/html/demo7/dist/../src/media/svg/icons/Devices/iPhone-X.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">کد پیامک‌ها</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{route('admin.kavimo')}}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Media/Movie-Lane2.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">کاویمو</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{route('admin.invoiceCreate')}}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Shopping\Sale2.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <span class="nav-text font-weight-bold">فاکتور ساز</span>
                        </a>
                    </li>
                    <li class="nav-item mr-3">
                        <a class="nav-link " href="{{ route('auth.logout') }}">
                            <span class="nav-icon mr-2">
                                <span class="svg-icon svg-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\Navigation\Sign-out.svg--><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text font-weight-bold">خروج</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<div class="flex-row-auto d-none d-md-block d-print-none" id="kt_profile_aside">
    <!--begin::Nav Panel Widget 1-->
    <div class="card card-custom gutter-b rounded-xl shadow">
        <!--begin::Body-->
