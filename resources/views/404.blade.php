...
<body id="kt_body" class="header-fixed header-mobile-fixed page-loading" dir="rtl">
    <!--begin::Main-->
        ...
        <div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center"
            ...
            <div
                ...
                <div class="alert alert-custom alert-light-danger fade show mb-5" role="alert">
                    ...
                    <div class="alert-text font-size-h3 font-weight-bolder">به نظر میاد صفحه ای که دنبالش بودید پیدا نشد.</div>
                    <div class="alert-close"></div>
                </div>
                <a href="#" class="btn btn-light-primary">
                    <i class="flaticon-reply"></i> بازگشت به صفحه اصلی
                </a>
            </div>
            <!--end::Content-->
        </div>
