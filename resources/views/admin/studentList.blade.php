...
@section('content')
    ...
    <div class="flex-row-fluid">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <form action="{{ route('course.importUser',$course->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start">
                    <span class="card-label font-weight-bolder text-dark">ثبت نام دانش آموز در کلاس</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--Begin::Body-->
            <div class="card-body">
                <form method="post" action="{{ route('course.courseStudentCreateAdmin', [$course->id]) }}">
                    @csrf
                    <div class="form-group row">
                        <div class="col-md-6 col-12">
                            <label class="font-size-h6 font-weight-bolder text-dark">اطلاعات دانش آموز</label>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="alert  alert-custom alert-secondary" role="alert">
                                <div class="alert-icon"><i class="flaticon-questions-circular-button"></i></div>
                                <div class="alert-text">
                                    برای وارد کردن دانش آموز لازم است که از الگوی زیر پیروی کنید <br><br>
                        ...
                        <div class="card card-custom gutter-b shadow-none">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">لیست دانش آموز های
                                        {{ $course->name }}</span>
                                </h3>
