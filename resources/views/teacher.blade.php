                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="overlay">
                                <div class="overlay-wrapper rounded text-center">
                                    <img src="{{ asset('storage/' . $teacher->photo->filePath()) }}" alt=""
                                        class="w-50 lazyload rounded-circle" />
                                </div>
                            </div>
                            <!--end::Image-->
                            @endisset
                            ...
                            <div class="text-center mt-2 mb-0 d-flex flex-column">
                                <a href="#"
                                    class="font-size-h3 mx-4 my-2 font-weight-bolder text-dark-75 text-hover-primary mb-1 add-loader">{{ $teacher->first_name . ' ' . $teacher->last_name }}</a>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title m-0 font-weight-bolder font-size-h4 text-dark">
                            دوره هاي {{ $teacher->first_name . ' ' . $teacher->last_name }}
                        </h3>
                    </div>
                    <hr>
                    <!--end::Header-->
                    <div class="card-body pt-2">
                        <div class="row">
                            ...
                            <div class="alert alert-custom alert-light-warning fade show mb-5" role="alert">
                                ...
                                <div class="alert-text">هیچ دوره ای برای این معلم ثبت نشده است !!!</div>
