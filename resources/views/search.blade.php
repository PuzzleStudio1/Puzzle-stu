...
@section('title', 'پازل استودیو | جستجو')
                            ...
                            <div id="collapseTwo7" class="collapse" data-parent="#accordionExample7">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item font-size-h6 font-weight-bold"><a
                                                class="text-dark text-hover-warning"
                                                href="{{ route('category.frontend', 18) }}">سایر وبینار های درسی</a>
                                        </li>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item font-size-h6 font-weight-light"><a
                                                    class="text-dark text-hover-warning"
                                                    href="{{ route('category.frontend', 14) }}">مشاوره کنکور</a>
                                            </li>
                                        </ul>
                                        </li>
                                    </ul>
            ...
            <div class="col-md-9 col-12">
                <div class="card card-custom bgi-no-repeat gutter-b card-stretch p-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h2 class="font-weight-bolder text-dark font-size-h3 mb-0">نتایج جستجو برای عبارت {{ $text }}
                        </h2>
                    </div>
                    <hr>
                    <!--end::Heading-->
                    ...
                    <div class="alert alert-custom alert-light-primary fade show mb-5" role="alert">
                        ...
                        <div class="alert-text">چیزی یافت نشد !!!</div>
