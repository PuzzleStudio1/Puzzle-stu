                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">دوره ها</span>
                        </h3>
                        <div class="card-toolbar">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-6">
                                <!--begin::Card-->
                                <div class="card card-custom shadow-sm my-2">
                                    <div class="card-body p-0">
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('webinar.frontend', $course->id) }}"
                                                class="font-size-h3 font-weight-bolder text-dark-75 text-hover-warning mx-4">{{ $course->name }}</a>
                                            <div class="mx-4">
                                                <a href="{{ route('teacher.frontend', $course->teacher) }}"
                                                    class="font-size-lg text-dark-50 text-hover-primary">{{ $course->teacher->first_name . ' ' . $course->teacher->last_name }}</a>

                                            </div>
                                        </div>
                                        <!--end::Details-->
                                        <hr class="m-0">
                                        <div class="mx-4 d-flex flex-md-row flex-column justify-content-between">

                                            @if ($course->type == 'free' || $course->type == 'login')
                                            <span
                                                class="align-self-center text-dark font-weight-light font-size-h6">رايگان</span>
                                            @else
                                            <span
                                                class="align-self-center text-dark font-weight-light font-size-h6 mt-4 mt-md-0">غیر
                                                رایگان</span>
                                            @endif
                                            <a href="{{ route('webinar.frontend', $course->id) }}"
                                                class="btn btn-warning my-2 my-md-4 py-2 py-md-4">
                                                ورود به وبینار
                                            </a>
                                        </div>
                                    </div>
...
<div class="d-flex flex-column-fluid">
    <div class="container-fluid">
        <div class="row bg-black d-flex flex-md-row flex-column-reverse mt-md-0">
            <div class="col-12 px-0 webinar_player">
                <div class="text-center">
                    <p class="font-size-h1 p-30 text-light-white font-weight-boldest"> کلاس ها در صفحه اساتید که در
                        پایین همین صفحه قرار دارد برگزار میگردد. <br>جهت ثبت نام در دوره ها با شماره ۰۹۱۲۰۶۴۳۰۶۹ تماس
                        حاصل فرمایید. </p>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-4 col-6">
                                ...
                                <div class="card card-custom border-lg my-2">
                                    <div class="card-body p-0">
                                        ...
                                        <!--end::Details-->
                                        <hr class="m-0">
                                        <div class="mx-4 d-flex flex-md-row flex-column justify-content-between align-items-center">
                                            ...
                                            @else
                                            <span
                                                class="align-self-center text-primary font-weight-normal">غیر
                                                رایگان</span>
                                            @endif
                                            <a href="{{ route('webinar.frontend', $course->id) }}"
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="text-left mt-5 mb-0 d-flex flex-column">
                                ...
                                <div class="fon-size-h6 font-weight-normal mx-4 my-2 text-danger">
                                    ...
                                    <br>
                                    <form action="{{ route('CodeLoginSinuhe', $course->id) }}" method="post"
                                        class="mt-5">
                                        @csrf
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="text-left mt-5 mb-0 d-flex flex-column">
                                ...
                                <div class="fon-size-h6 font-weight-normal mx-4 my-2 text-danger">
                                    اين دوره رايگان است و شما براي استفاده از دوره باید ثبت نام کنید.
                                    <br>
                                    <a href="{{ route('sinuheSign') }}" class="w-100 btn btn-success my-4 py-4">
                                        ثبت نام
                                    </a>
                                </div>
                                @endif
